...
<body>
      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="themuser.php">
                <i class="fas fa-user text-primary"></i>
                <span class="nav-link-text">Thêm user</span>
              </a>
            </li>
          </ul>
        </div>
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Thêm user</h6>
            </div>
          </div>
        </div>
      </div>
              ...
              <form method="POST">
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-tensanpham">Email</label>
                        <input type="email" name="email" class="form-control" placeholder="VD: retailer@gmail.com">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-ngaytao">Password</label>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <input name="submit" class="form-control" value="Lưu thông tin" type="submit" style="background-color: #5e72e4 !important; color: white;">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
  ...
  <?php
   if(isset($_POST['submit']) && ($_POST['submit']=='Lưu thông tin')){
        include "../connect.php";
        ...
        $str = "INSERT INTO `user`(`email`, `password`, `role`) VALUES ('$email','$password','$role') ";
