        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
             ...
             <li class="nav-item">
              <a class="nav-link" href="themsanpham_nongdan.php">
              ...
              <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="media align-items-center">
                  ...
                  <div class="media-body  ml-2  d-none d-lg-block">
                    <span class="mb-0 text-sm  font-weight-bold">Nông dân</span>
                  </div>
                </div>
              </a>
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Thêm thông tin từ nông dân</h6>
            </div>
          </div>
        </div>
      </div>
              ...
              <div>
                ...
                <div class="row">
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="form-group">
                        <label class="form-control-label">Nơi sản xuất</label>
                        <input id="input-noisanxuat" type="text" name="noisanxuat" class="form-control" placeholder="VD: Thành phố Thủ Đức">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label">Ngày gieo trồng</label>
                        <input id="input-ngaygieotrong" type="date" name="ngaygieotrong" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label">Ngày thu hoạch</label>
                        <input id="input-ngaythuhoach" type="date" name="ngaythuhoach" class="form-control" placeholder="">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="form-group">
                        <label class="form-control-label">Các loại thuốc sử dụng</label>
                        <input id="input-cacloaithuocsudung" type="text" name="thuocsudung" class="form-control" placeholder="VD: Phân lân">
                      </div>
                    </div>
                  </div>
  ...
  <script>
    ...
    if (typeof web3 !== 'undefined') {
      ...
      $("#input-luuthongtin").on("click", function(){
        ...
        then(data=>{
          var account=data[0].nongdan;
        var contract = new web3.eth.Contract(contractAbi, contractAddress);
        var idsanpham = $('#input-idsanpham').val();
        var noisanxuat = $('#input-noisanxuat').val();
        var ngaygieotrong =  $('#input-ngaygieotrong').val();
        var ngaythuhoach=  $('#input-ngaythuhoach').val();
        var cacloaithuocsudung=  $('#input-cacloaithuocsudung').val();
        console.log(cacloaithuocsudung)
        web3.eth.getAccounts().then(async function() {
        var receipt = await contract.methods.thongtinnongdan(idsanpham, noisanxuat,ngaygieotrong,ngaythuhoach,cacloaithuocsudung).send({ from: account, gas: 1000000 })
      ...
      $("#input-xoa").on("click", function(){
        $('#input-idsanpham').val('');
        $('#input-noisanxuat').val('');
        $('#input-ngaygieotrong').val('');
        $('#input-ngaythuhoach').val('');
        $('#input-cacloaithuocsudung').val('');
      });
  </script>
</body>
