        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
             ...
             <li class="nav-item">
              <a class="nav-link" href="themsanpham_vanchuyen.php">
              ...
              <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="media align-items-center">
                  ...
                  <div class="media-body  ml-2  d-none d-lg-block">
                    <span class="mb-0 text-sm  font-weight-bold">Vận chuyển</span>
                  </div>
                </div>
              </a>
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Thêm thông tin vận chuyển</h6>
            </div>
          </div>
        </div>
      </div>
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <input id="input-noidi" type="text" name="noisanxuat" class="form-control" placeholder="VD:Từ Thành phố Thủ Đức">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <input id="input-noiden" type="text" name="noisanxuat" class="form-control" placeholder="VD:Đến Thành phố Quận 1">
                      </div>
                    </div>
                  </div>
  ...
  <script>
    ...
    if (typeof web3 !== 'undefined') {
      ...
      $("#input-luuthongtin").on("click", function(){
        ...
        then(data=>{
          var account=data[0].vanchuyen;
        var contract = new web3.eth.Contract(contractAbi, contractAddress);
        var idsanpham = $('#input-idsanpham').val();
        var noidi = $('#input-noidi').val();
        var noiden =  $('#input-noiden').val();
      
        web3.eth.getAccounts().then(async function() {
        var receipt = await contract.methods.thongtinvanchuyen(idsanpham, noidi,noiden).send({ from: account, gas: 1000000 })
